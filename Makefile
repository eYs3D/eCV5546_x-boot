...
ifeq ($(CONFIG_LPDDR4),y)
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_pmu_train_imem.bin $(BIN)/pmu_train_imem.img 0 im1d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_pmu_train_dmem.bin $(BIN)/pmu_train_dmem.img 0 dm1d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_2d_pmu_train_imem.bin $(BIN)/2d_pmu_train_imem.img 0 im2d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_2d_pmu_train_dmem.bin $(BIN)/2d_pmu_train_dmem.img 0 dm2d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_diags_imem.bin $(BIN)/diags_imem.img 0 imda
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/lpddr4/lpddr4_diags_dmem.bin $(BIN)/diags_dmem.img 0 dmda
endif
ifeq ($(CONFIG_DDR4),y)
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_pmu_train_imem.bin $(BIN)/pmu_train_imem.img 0 im1d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_pmu_train_dmem.bin $(BIN)/pmu_train_dmem.img 0 dm1d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_2d_pmu_train_imem.bin $(BIN)/2d_pmu_train_imem.img 0 im2d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_2d_pmu_train_dmem.bin $(BIN)/2d_pmu_train_dmem.img 0 dm2d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_diags_imem.bin $(BIN)/diags_imem.img 0 imda
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr4/ddr4_diags_dmem.bin $(BIN)/diags_dmem.img 0 dmda
endif
ifeq ($(CONFIG_DDR3),y)
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr3/ddr3_pmu_train_imem.bin $(BIN)/pmu_train_imem.img 0 im1d
	@bash ./add_xhdr.sh ../draminit/dwc/firmware/eCV5546/ddr3/ddr3_pmu_train_dmem.bin $(BIN)/pmu_train_dmem.img 0 dm1d
endif
...
dwc:
	@echo ">>>>>>>>>>> Build dwc obj"
	$(MAKE) -C ../draminit/dwc ARCH=$(ARCH) CROSS=$(CROSS) PLATFROM=eCV5546
...
# mmu
CSOURCES += arch/arm/ecv5546/cache.c
...
a64bin:
	@echo "Build a64 bin"
	@$(MAKE) -C arch/arm/ecv5546/a64up/
	@$(CROSS)objcopy -I binary -O elf32-littlearm -B arm --rename-section .data=.a64bin arch/arm/ecv5546/a64up/a64up.bin arch/arm/ecv5546/a64up/a64bin.o
...
.PHONY: clean
clean:
	@$(MAKE) -C arch/arm/ecv5546/a64up/ clean
